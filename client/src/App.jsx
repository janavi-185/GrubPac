    ...
    <>
      ...
      <nav className="navbar">
        ...
        <div className="nav-cta">
          <a className="btn btn-outline" href={`${API}/api-docs`} target="_blank" rel="noreferrer">
            Swagger Docs
          </a>
          <a className="btn btn-primary" href={`${API}/api/auth/register`} target="_blank" rel="noreferrer">
            Get Started
          </a>
        </div>
      </nav>
      ...
      <section className="hero">
        ...
        <div className="hero-actions">
          <a className="btn btn-primary btn-lg" href={`${API}/api-docs`} target="_blank" rel="noreferrer">
            Explore API Docs ↗
          </a>
